...
public class CarController : ControllerBase
{
    ...
    public IActionResult GetCarById(int id)
    {
        ...
        return null == result ? NotFound() : new JsonResult(_carService.GetCarDto(result));
    }
    ...
    public IActionResult GetCategory(int id)
    {
        ...
        return null == result ? NotFound() : new JsonResult(_carService.GetCategoryDetailDto(result));
    }
